      ...
      {submitted ? (
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 mb-6">
            Ми надіслали посилання для відновлення пароля на адресу <strong>{email}</strong>
          </p>
          <Link 
            href="/login"
        ...
        <>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm">
              Введіть вашу електронну адресу, і ми надішлемо вам посилання для відновлення
            </p>
          </div>
